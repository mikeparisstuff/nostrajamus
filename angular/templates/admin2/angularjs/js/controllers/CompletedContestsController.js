...
MetronicApp.controller('CompletedContestsController', ['$rootScope', '$scope', 'settings', 'contestInfo', 'contestEntries', '$sce', '$http', function($rootScope, $scope, settings, contestInfo, contestEntries, $sce, $http) {

...
MetronicApp.controller('InProgressContestsController', ['$rootScope', '$scope', 'settings', 'contestInfo', 'contestEntries', '$sce', function($rootScope, $scope, settings, contestInfo, contestEntries, $sce) {
